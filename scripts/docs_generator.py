...
class ProjectDocumentationGenerator:
                        ...
                        if 'variable' in config:
                            if isinstance(config['variable'], dict):
                                for var_name, var_config in config['variable'].items():
                                    ...
                                    self.terraform_modules[module]['variables'].append(
                                        f"{var_name} ({var_type})"
                                    )
    ...
    def update_documentation(self):
        """Update project documentation with infrastructure diagrams and details."""
        ...
        print("✅ Documentation updated with infrastructure diagrams and details")
